        ...
        <section id="about" className="py-20 md:py-32">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="text-center text-sky-700 text-lg md:text-xl">
              <p className="mb-6">
                Stack Test Group is a leading provider of stack testing services for industrial facilities and has been in the business for over 30 years. We have a team of certified professionals that deliver accurate and reliable emissions testing to ensure your compliance with environmental regulations.
              </p>
              <p>
